...
public class Utillity {
     ...
     */
    public boolean doesInputEndWithEnd(String input, String end) { return input.endsWith(end); }
     ...
     */
    public String allCapitalsAndNoWhiteSpace(String aString) { return aString.toUpperCase().trim(); }
